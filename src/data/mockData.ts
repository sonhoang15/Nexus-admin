import { User, Category, Product, Page, Document, Setting } from '@/types';
...
export const mockCategories: Category[] = [
  { id: '1', name: 'Electronics', description: 'Modern gadgets and computing devices', productCount: 124, createdAt: '2024-01-10' },
  { id: '2', name: 'Accessories', description: 'Peripheral items and add-ons', productCount: 56, createdAt: '2024-01-12' },
  { id: '3', name: 'Audio', description: 'Headphones, speakers and sound systems', productCount: 89, createdAt: '2024-01-15' },
  { id: '4', name: 'Home Appliances', description: 'Devices for household usage', productCount: 32, createdAt: '2024-01-18' },
  { id: '5', name: 'Wearables', description: 'Smartwatches and fitness trackers', productCount: 41, createdAt: '2024-01-20' },
  { id: '6', name: 'Gaming', description: 'Consoles and gaming peripherals', productCount: 67, createdAt: '2024-01-25' },
  { id: '7', name: 'Networking', description: 'Routers, switches and networking gear', productCount: 15, createdAt: '2024-02-01' },
  { id: '8', name: 'Photography', description: 'Cameras and lenses', productCount: 28, createdAt: '2024-02-05' },
];
